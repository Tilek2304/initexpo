...
from .models import DepartmentINIT, TeacherINIT, ContactINIT, AboutspiINIT, AwardINIT

class TeacherINITAdminForm(forms.ModelForm):
    bio = forms.CharField(widget=CKEditorWidget())
    class Meta:
        model = TeacherINIT
        fields = '__all__'

class TeacherINITAdmin(admin.ModelAdmin):
    form = TeacherINITAdminForm
...
class AboutspiINITAdminForm(forms.ModelForm):
    content = forms.CharField(widget=CKEditorWidget())
    class Meta:
        model = AboutspiINIT
        fields = '__all__'

class AboutspiINITAdmin(admin.ModelAdmin):
    form = AboutspiINITAdminForm

class ContactINITAdminForm(forms.ModelForm):
    content = forms.CharField(widget=CKEditorWidget())
    class Meta:
        model = ContactINIT
        fields = '__all__'

class ContactINITAdmin(admin.ModelAdmin):
    form = ContactINITAdminForm

admin.site.register(TeacherINIT, TeacherINITAdmin)
admin.site.register(ContactINIT, ContactINITAdmin)
admin.site.register(AboutspiINIT, AboutspiINITAdmin)
admin.site.register(AwardINIT)  # Зарегистрировать модель AwardINIT
