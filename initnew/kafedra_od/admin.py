...
from .models import DepartmentOD, TeacherOD, ContactOD, AboutspiOD, AwardOD

class TeacherODAdminForm(forms.ModelForm):
    bio = forms.CharField(widget=CKEditorWidget())
    class Meta:
        model = TeacherOD
        fields = '__all__'

class TeacherODAdmin(admin.ModelAdmin):
    form = TeacherODAdminForm
...
class AboutspiODAdminForm(forms.ModelForm):
    content = forms.CharField(widget=CKEditorWidget())
    class Meta:
        model = AboutspiOD
        fields = '__all__'

class AboutspiODAdmin(admin.ModelAdmin):
    form = AboutspiODAdminForm

class ContactODAdminForm(forms.ModelForm):
    content = forms.CharField(widget=CKEditorWidget())
    class Meta:
        model = ContactOD
        fields = '__all__'

class ContactODAdmin(admin.ModelAdmin):
    form = ContactODAdminForm

admin.site.register(TeacherOD, TeacherODAdmin)
admin.site.register(ContactOD, ContactODAdmin)
admin.site.register(AboutspiOD, AboutspiODAdmin)
admin.site.register(AwardOD)  # Зарегистрировать модель AwardOD
